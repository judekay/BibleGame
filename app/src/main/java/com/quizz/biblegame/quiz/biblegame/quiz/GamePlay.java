 ...
 public void incrementQuestionNum()
 {
  ...
  public List<Question> getQuestions() {
    ...
    public Question getPrevQuestion(){
        ...
        //get the prev question;
        this.setRound(this.getRound()-1);
        Question prev = questions.get(this.getRound());

        Log.d("TAG4", this.getRound()+"");
        //update the round number to prev question
//        this.setRound(this.getRound()-1);
        return prev;
  ...
  public Question getNextQuestion(){
    ...
    Question next = questions.get(this.getRound());
      ...
      Log.d("TAG4", this.getRound()+"");
    //update the round number to the next number
