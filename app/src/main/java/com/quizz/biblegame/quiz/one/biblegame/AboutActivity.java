  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    InputStream localInputStream = getResources().openRawResource(R.raw.bibleabout);
    try
    {
      ((TextView)findViewById(R.id.aboutText)).setText(inputStreamToString(localInputStream));
      return;
    }
